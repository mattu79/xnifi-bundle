package io.activedata.xnifi2.core.sql;
...
public class BatchSelectProcessorTests {
    ...
    DBCPServiceSimpleImpl dbcpService;
    ...
    public void test2() throws IOException {
        ...
        Sql2o sql2o = Sql2oUtils.create(dbcpService.getDataSource());
        ...
        runner.setProperty(BatchSelectProcessor.PROP_SQL, "SELECT edits, total FROM user_edits WHERE username = :name");
        runner.enqueue(TEST_JSON);
        runner.run();
        runner.assertAllFlowFilesTransferred(BatchSelectProcessor.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(BatchSelectProcessor.REL_SUCCESS);
