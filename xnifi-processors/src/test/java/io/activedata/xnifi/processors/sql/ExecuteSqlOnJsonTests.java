...
public class ExecuteSqlOnJsonTests {
    ...
    public void setup() throws InitializationException {
        ...
        runner.setProperty(ExecuteSqlOnJson.PROP_SQL, TEST_TABLE_SQL);
    }
    ...
    public void test1() throws UnsupportedEncodingException {
        runner.setProperty(ExecuteSqlOnJson.PROP_SQL, "SELECT 1.5 AS `use`, 10001 AS pid \n" +
                "FROM DUAL");
        runner.enqueue(TEST_JSON);
        runner.run();
        runner.assertAllFlowFilesTransferred(ExecuteSqlOnJson.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(ExecuteSqlOnJson.REL_SUCCESS);
    ...
    public void test2() throws UnsupportedEncodingException {
        ...
        runner.setProperty(ExecuteSqlOnJson.PROP_SQL, sql);
        runner.setProperty(ExecuteSqlOnJson.PROP_SQL_MODE, "INSERT/UPDATE/DELETE");
        runner.enqueue("{}");
        runner.run();
        runner.assertAllFlowFilesTransferred(ExecuteSqlOnJson.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(ExecuteSqlOnJson.REL_SUCCESS);
