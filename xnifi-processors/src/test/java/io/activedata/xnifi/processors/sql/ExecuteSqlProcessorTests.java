...
public class ExecuteSqlProcessorTests {
    ...
    public void setup() throws InitializationException {
        ...
        runner.setProperty(BatchSqlProcessor.PROP_SQL, TEST_TABLE_SQL);
        runner.setProperty(BatchSqlProcessor.PROP_RECORD_OUTPUT_BUILDER, "attributes.test = 'xxx';");
    }
    ...
    public void test1() throws UnsupportedEncodingException {
        runner.setProperty(BatchSqlProcessor.PROP_SQL, "SELECT 1.5 AS `use`, 10001 AS pid \n" +
                "FROM DUAL");
        runner.enqueue(TEST_JSON);
        runner.run();
        runner.assertAllFlowFilesTransferred(BatchSqlProcessor.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(BatchSqlProcessor.REL_SUCCESS);
    ...
    public void test2() throws UnsupportedEncodingException {
        ...
        runner.setProperty(BatchSqlProcessor.PROP_SQL, sql);
        runner.setProperty(BatchSqlProcessor.PROP_SQL_MODE, "INSERT/UPDATE/DELETE");
        runner.enqueue("{}");
        runner.run();
        runner.assertAllFlowFilesTransferred(BatchSqlProcessor.REL_SUCCESS, 1);
        List<MockFlowFile> flowFiles = runner.getFlowFilesForRelationship(BatchSqlProcessor.REL_SUCCESS);
